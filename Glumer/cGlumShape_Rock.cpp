...
void cGlumShape_Rock::Start(cMovementBase *world_offset)
{
   if (mTimer != NULL) throw -943;
	...
	// make larger rocks have thicker lines so they're easier to differenciate from small slow rocks close up
